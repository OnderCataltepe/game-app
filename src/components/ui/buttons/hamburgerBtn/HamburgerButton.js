const HamburgerButton = ({ openMenu, setOpenMenu }) => {
  return (
    <div className="z-30 flex items-center justify-center md:hidden">
      <div>
        <input
          id="hamburger"
        ...
        >
          <span>
            <span className="m-1 block h-0.5 w-[22px] bg-black transition-all duration-300 dark:bg-gray-200 "></span>
            <span className="m-1 block h-0.5 w-[18px] bg-black opacity-100 transition-all duration-300 dark:bg-gray-200 "></span>
            <span className="m-1 block h-0.5 w-[22px] bg-black transition-all duration-300 dark:bg-gray-200 "></span>
          </span>
        </label>
      </div>
